...
import type { ClosetCategory, ClosetColor, ClosetItem } from "@/features/closet/types/closet-item";
...
export const mockClosetRepository: ClosetDataRepository = {
  ...
  updateClothes: async (clothesId, payload) => {
    ...
    const nextColor = (payload.color ?? item.color) as ClosetColor;
    const nextCategory = (payload.category ?? item.category) as ClosetCategory;
    const nextSectionId = (payload.sectionId ?? item.sectionId) as ClosetSectionId;
...
export const apiClosetRepository: ClosetDataRepository = {
  getTemplate: mockClosetRepository.getTemplate,
  getAllItems: mockClosetRepository.getAllItems,
  getItemsBySectionId: mockClosetRepository.getItemsBySectionId,
  getItemById: mockClosetRepository.getItemById,
  searchClothes: async ({ searchParams, page, size }) => {
